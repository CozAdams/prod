({
	init : function(cmp, event, helper) {
        ...
        styleText=styleText + "background-color:" + cmp.get("v.styleBackgroundColor") + ";";
        styleText=styleText + "color:" + cmp.get("v.styleTextColor") + ";";
        ...
        styleText=styleText + "width:" + cmp.get("v.imageWidth") + ";height:" + cmp.get("v.imageHeight") + ";cursor: pointer; display: inline-block;";
        cmp.set("v.styleText", styleText);
	},
    
    handleClick : function(cmp, event, helper) {
        cmp.set("v.isClicked" , true);
        let enrollmentEvent = cmp.getEvent("enrollmentEvent");
        enrollmentEvent.setParams({
            "enrollmentType": cmp.get("v.enrollmentType")
        });
